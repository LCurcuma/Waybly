...
<div class="details">
    ...
    <div class="infobio">
        <p class="overskriftbio">Netto Fejøgade</p>
    ...
    <div class="kommentarer">
        <span class="overskriftkommentar pb-5">Kommentarer</span> <i class="fa-solid fa-comments kommentaricon" style="color:#00B4D7;"></i>
    </div>
...
<script>
    //laver en liste over alle elementer med klassen 'statusbox' og gemmer dem i 'statusBoxes'.
